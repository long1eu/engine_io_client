...
void main() {
  test('uri', () {
    final TransportOptions options = new TransportOptions((TransportOptionsBuilder b) {
      b
        ..path = '/engine.io'
        ..hostname = 'localhost'
        ..secure = false
        ..query = new MapBuilder<String, String>(<String, String>{'sid': 'test'})
  ...
  test('wsUri', () {
    final TransportOptions options = new TransportOptions((TransportOptionsBuilder b) {
      b
        ...
        ..hostname = 'test'
        ..secure = false
        ..query = new MapBuilder<String, String>(<String, String>{'transport': 'WebSocket'})
        ..timestampRequests = false;
    });
